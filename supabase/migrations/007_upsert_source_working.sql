-- Working fix for upsert_source
-- The issue was ON CONFLICT (domain) - it needs to use the constraint name
...
-- Test it
SELECT * FROM upsert_source('test-working-domain.com', 'eb4aa659-1f04-4611-a385-179a6e4cfd62'::uuid);
